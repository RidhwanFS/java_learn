...
<body>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 class="text-primary m-0"><i class="fa fa-map-marker-alt me-3"></i>JAVA LEARN</h1>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="" class="btn btn-primary rounded-pill py-2 px-4">Sign up / Sign in</a>
            </div>
        </nav>
    ...
    <!-- About Start -->
    <div class="container-xxl py-5" id="about" <?php $page = "about" ?>>
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">JAVA LEARN adalah sebuah platform pendidikan daring yang didedikasikan untuk
                    ...
                    <p class="mb-4">JAVA LEARN hadir untuk menjadi sumber informasi terpercaya dan inspiratif tentang
